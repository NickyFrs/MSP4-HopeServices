...
class TestBasketViews(TestCase):
    def setUp(self):
        ...
        Product.objects.create(category_id=1, name='flute-lessons',
                               created_by_id=1, slug='flute-lessons-beginners',
                               price='20.00', active=True
                               )
        Product.objects.create(category_id=1, name='violin-lessons',
                               created_by_id=1, slug='violin-lessons-beginners',
                               price='20.00', active=True
                               )
        self.client.post(
    ...
    def test_basket_add(self):
        ...
        response = self.client.post(
            reverse("basket:basket_add"), {"product": 3,
                                           "productqty": 1,
                                           "action": "post"},
            xhr=True
        )
