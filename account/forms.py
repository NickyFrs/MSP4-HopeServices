...
class RegistrationForm(forms.ModelForm):
    ...
    email = forms.EmailField(
        ...
        max_length=100,
        help_text="Required",
        error_messages={"required": "Sorry, you need an email address"},
        required=True,
    )
    ...
    password2 = forms.CharField(
        label="Confirm Password", min_length=4, widget=forms.PasswordInput
    )
...
class UserEditForm(forms.ModelForm):
    ...
    email = forms.EmailField(
        label="Account Email (can't be changed)",
        max_length=200,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
    ...
    username = forms.CharField(
        label="Account Username (can't be changed)",
        max_length=50,
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
...
class PasswordResetForm(PasswordResetForm):
    ...
    def clean_email(self):
        ...
        if not u:
            raise forms.ValidationError("Looks like that account is not in our system")
        return email
