...
urlpatterns = [
    ...
    path('password_reset/password_reset_confirmation_email/',
         TemplateView.as_view(template_name="account/user/reset_status.html"), name='password_reset_status'),
    ...
    path('profile/delete_confirmation/', TemplateView.as_view(template_name="account/user/delete_confirmation.html"),
