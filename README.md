...
Some testing using done manual code testing and coverage was done to the basket app views.py file as well as the store app
 views.py and model.py. The report can be viewed [here](/htmlcov/index.html) by opening the index file inside the htmlcov folder
